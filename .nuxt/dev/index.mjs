...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/ufo/dist/index.mjs';
...
import { stringify, uneval } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/radix3/dist/index.mjs';
...
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/user/Desktop/main-land/emle%20landing/node_modules/unhead/dist/utils.mjs';
...
const _Ebyv3lMdJyEwYe_VOMAj6E3q9iK9Tod8q4Gynh982OA = (function(nitro) {
...
const _JTltpMlzyB7R9tYQgDzNVSbbY6i6_iuoDCVfQyqQc2M = (nitroApp) => {
...
const _QTfggbbGcNCePFKaKDMoHJ3O_mX7v8BcDTt3_5bW0d4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"1c4e5-brTaXe9wMmXI2RIMe2yn625EkT0\"",
    "mtime": "2026-03-26T18:31:52.865Z",
    "size": 115941,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"6dadd-aEW24ys7VJbDfFDl+SIVCf4KV68\"",
    "mtime": "2026-03-26T18:31:52.865Z",
    "size": 449245,
    "path": "index.mjs.map"
  }
...
const _AzXI8W = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/user/Desktop/main-land/emle%20landing/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Users/user/Desktop/main-land/emle%20landing/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const handlers = [
  { route: '', handler: _AzXI8W, lazy: false, middleware: true, method: undefined },
